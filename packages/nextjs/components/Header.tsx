      ...
      <div className="navbar-start w-auto xl:w-1/2">
        ...
        <Link href="/" passHref className="hidden xl:flex items-center gap-1 ml-4 mr-6 shrink-0">
          <div className="flex relative w-10 h-10">
            <Image alt="SE2 logo" className="cursor-pointer" fill src="/ETHStateLogo2.svg" />
          </div>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">ETHState</span>
            <span className="text-xs">Estate on Ethereum</span>
          </div>
        </Link>
